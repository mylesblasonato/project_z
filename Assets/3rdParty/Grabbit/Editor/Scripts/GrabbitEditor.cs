...
namespace Grabbit
{
    public class GrabbitEditor : EditorWindow
    {
        ...
        private bool DisplayPreferenceParams()
        {
            ...
            modif = modif || GUIHelper.DisplayBoolOption(
                "Reset To Default Physics On Exit",
                ref CurrentSettings.ResetToDefaultPhysicsValues, false,
                "Resets Physics settings to default ones when exiting Grabbit instead of saved previous ones (safer)");
